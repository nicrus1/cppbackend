...
public:
    ...
    std::chrono::milliseconds GetTimeWithoutLoot() const { return time_without_loot_; }
    void SetTimeWithoutLoot(std::chrono::milliseconds time) { time_without_loot_ = time; }
